 ...
 */
export default class DoubleRangeElement extends foundry.applications.elements.HTMLRangePickerElement {
	static {
		window.customElements.define("blackflag-doublerange", DoubleRangeElement);
	}
	...
	/** @override */
	static tagName = "blackFlag-doublerange";
