...
- **Кости Хитов:** 1к6 за уровень чародея
...
**Владение (Proficiencies)**

- **Доспехи:** Нет
- **Оружие:** Простое оружие
- **Инструменты:** Нет
- **Спасброски:** Телосложение (ТЕЛ), Харизма (ХАР)
- **Навыки:** Выберите два из: Магия (Arcana), Обман (Deception), Проницательность (Insight), Запугивание (Intimidation), Убеждение (Persuasion) и Религия (Religion)

**Начальное снаряжение (Starting Equipment)**
...
### ПОДКЛАСС ЧАРОДЕЯ (SORCERER SUBCLASS)
...
### ДРАКОНИЙ ПОДКЛАСС (DRACONIC SUBCLASS)
